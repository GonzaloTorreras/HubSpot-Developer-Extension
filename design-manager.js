    ...
    function sprocky() {
        chrome.storage.sync.get(['sprocky'], function(result) {
            ...
            if (result.sprocky || result.sprocky == undefined) {
                ...
                var quotes  = 
                ["Hi, it looks like youre looking to build a custom module. Do you need assistance?",
                "Sufficiently advanced technology is equivalent to magic. Therefore you, must be a wizard.",
                "/*no comment on your code*/",
                "Its dangerous to go alone take $(this)",
                "Grammarly says Sprocky isnt a word. I say Grammarly isnt a word.",
                "BOO! did I scare you? Im Sprocky. Here to help.",
                "We interrupt your regularly scheduled programming to let you know, theres a typo in this code. Sprocky signing off.",
                ...
                "Hi Im Sprocky, youre missing a semi-colon somewhere.",
                ...
                "Hi the names Sprocky, Ill be here all week.",
                "The names Sprocky, just wanted to tell you in the chrome extension popup theres a toggle for dark theme and a handy developer menu.",
                "The HubSpot Developer slack is where the culprits that created me lie. Find them in #developer-extension",
                "I dont always peak at your code, but when I do...",
                "Refactoring - aint nobody got time for that.",
                "One does not simply grow hair like Will Spiros.",
                "It looks like youre frustrated with that bug, how about I turn CAPS lock for you?",
                "Remember, if your project doesnt blow peoples minds, atleast its better than Microsoft Bob.",
